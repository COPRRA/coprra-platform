...
class SecurityHeadersService
{
    ...
    private function getContentSecurityPolicy(Request $request): string
    {
        ...
        // Allow CDN resources for jQuery, Bootstrap, Chart.js
        $scriptSrc = $isLocal
            ? "script-src 'self' 'nonce-{$nonce}' 'strict-dynamic' 'unsafe-eval' {$viteHost} https://code.jquery.com https://cdn.jsdelivr.net https://cdnjs.cloudflare.com https:;"
            : "script-src 'self' 'nonce-{$nonce}' 'strict-dynamic' 'unsafe-eval' https://code.jquery.com https://cdn.jsdelivr.net https://cdnjs.cloudflare.com https:;";
        ...
        return implode(' ', [
            ...
            "object-src 'none';",
            $scriptSrc,
            "style-src 'self' 'nonce-{$nonce}' 'unsafe-inline' https://fonts.bunny.net https://cdn.jsdelivr.net https://cdnjs.cloudflare.com https:;",
            "img-src 'self' data: https:;",
            "font-src 'self' data: https://fonts.bunny.net https://cdnjs.cloudflare.com https:;",
            $connectSrc,
