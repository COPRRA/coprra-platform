...
class MigrateDataFromSqlite extends Command
{
    ...
    {
        $this->task('Migrating currencies', function () {
    ...
    {
        $this->task('Migrating languages', function () {
    ...
    {
        $this->task('Migrating categories', function () {
    ...
    {
        $this->task('Migrating brands', function () {
    ...
    {
        $this->task('Migrating stores', function () {
    ...
    {
        $this->task('Migrating products (164 expected)', function () {
    ...
    {
        $this->task('Migrating price offers', function () {
