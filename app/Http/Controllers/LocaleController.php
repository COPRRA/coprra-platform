...
class LocaleController extends Controller
{
    ...
    public function changeLanguage(Request $request, string $langCode): RedirectResponse
    {
        ...
        Session::put('locale_language', $code); // Also set for SetLocaleMiddleware
        
        // Save to cookie for persistence across sessions (30 days)
        Cookie::queue('locale', $code, 60 * 24 * 30);
    ...
    public function changeCurrency(Request $request, string $currencyCode): RedirectResponse
    {
        ...
        Session::put('locale_currency', $currency->code); // Also set for SetLocaleMiddleware
    ...
    public function changeCountry(Request $request, string $countryCode): RedirectResponse
    {
        ...
        // Save to cookie for persistence across sessions (30 days)
        Cookie::queue('locale_country', $country->code, 60 * 24 * 30);
