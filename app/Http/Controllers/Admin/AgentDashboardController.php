...
class AgentDashboardController extends Controller
{
        ...
        return Cache::remember('agent_dashboard_data', 30, function () {
            ...
            return [
                'overview' => [
                    ...
                    'stopped_agents' => $stats['paused'],
                    'failed_agents' => $stats['failed'],
                ],
                'statistics' => $stats,
                'agents' => $agents,
                'recent_activity' => $recentActivity,
                'system_health' => array_merge($systemHealth, [
                    'network_usage' => $systemHealth['network_latency'] ?? 0,
                ]),
                'metrics' => [
                    'throughput' => $this->getThroughputMetrics(),
                    'response_times' => $this->getResponseTimeMetrics(),
    ...
    private function getSystemHealth(): array
    {
        return [
            ...
            'cpu_usage' => random_int(30, 70),
            'memory_usage' => random_int(40, 80),
            'disk_usage' => random_int(20, 60),
            'network_latency' => random_int(10, 50),
            'active_connections' => random_int(50, 200),
        ];
    }
    ...
    {
        return [
            'average' => random_int(200, 400),
            'p50' => random_int(150, 300),
            'p95' => random_int(400, 800),
            'p99' => random_int(800, 1500),
            'max' => random_int(1500, 3000),
        ];
    }
    ...
    {
        return [
            'total_errors' => random_int(10, 100),
            'error_rate' => random_int(1, 5) / 10,
            'critical_errors' => random_int(0, 5),
            'by_type' => [
                'timeout' => random_int(5, 30),
                'connection' => random_int(2, 15),
                'validation' => random_int(3, 20),
                'internal' => random_int(1, 10),
            ],
        ];
    }
    ...
    private function getResourceUsageMetrics(): array
    {
        return [
            'cpu' => [
                'current' => random_int(30, 70),
                'average' => random_int(40, 60),
                'peak' => random_int(70, 95),
            ],
            'memory' => [
                'current' => random_int(4, 12),
                'average' => random_int(6, 10),
                'peak' => random_int(10, 16),
            ],
            'disk' => [
                'used' => random_int(100, 500),
                'available' => random_int(500, 1000),
                'usage_percent' => random_int(20, 60),
            ],
        ];
    }
    ...
    private function generateMockLogMessage(): string
    {
        ...
        return \sprintf($message, random_int(1000, 9999), random_int(100, 2000), 'cache_key_'.random_int(1, 100));
    }
}
