...
// use App\Http\Controllers\CartController; // Removed - Task 16
...
// use App\Http\Controllers\PointsController; // Removed - Task 16
...
Route::prefix('ai/health')->name('ai.health.')
...
// External Search
Route::get('search/external', [\App\Http\Controllers\ExternalSearchController::class, 'index'])->name('search.external');
...
// Product Offers Page (must come before generic product show route)
Route::get('products/{slug}/offers', [ProductController::class, 'showOffers'])->name('products.offers');
...
Route::middleware('auth')->group(static function (): void {
    ...
    // Points & Rewards Routes - REMOVED - Task 16
...
// Cart Routes (public, ensure web middleware is explicitly applied) - REMOVED - Task 16
