#!/bin/bash
# Get actual error from Laravel logs
...
expect {
    ...
    -re "\\\$ |# " {
        ...
        puts "============================================================"
        puts "Getting Actual Error from Laravel Logs"
        puts "============================================================"
        puts ""
        
        puts "1. Triggering route to generate error..."
        send "curl -s https://coprra.com/debug-sentry > /dev/null 2>&1\r"
        expect -re "\\\$ |# "
        
        puts ""
        puts "2. Getting latest error from logs..."
        send "tail -100 storage/logs/laravel.log | tail -50\r"
        expect -re "\\\$ |# "
