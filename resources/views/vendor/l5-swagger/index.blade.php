...
<script nonce="{{ $cspNonce ?? request()->attributes->get('csp_nonce', '') }}">
    window.onload = function() {
        ...
        const ui = SwaggerUIBundle({
            ...
            operationsSorter: @json(isset($operationsSorter) ? $operationsSorter : null),
            configUrl: @json(isset($configUrl) ? $configUrl : null),
            validatorUrl: @json(isset($validatorUrl) ? $validatorUrl : null),
            ...
            deepLinking: true,
            filter: @json((bool) config('l5-swagger.defaults.ui.display.filter')),
