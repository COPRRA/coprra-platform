    ...
    <div class="max-w-7xl mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
            ...
            <div class="bg-white rounded-lg shadow-md p-6">
                ...
                <ul class="space-y-2">
                    <li>
                        <a href="{{ route('account.points') }}" class="text-blue-600 hover:text-blue-800">
                            {{ __('My Points') }}
                        </a>
                    </li>
                    <li>
            ...
            <!-- Points Summary -->
            <div class="bg-white rounded-lg shadow-md p-6">
                <h2 class="text-xl font-semibold mb-4">{{ __('Points Summary') }}</h2>
                @php
                    $pointsService = app(\App\Services\PointsService::class);
                    $availablePoints = $pointsService->getAvailablePoints(auth()->id());
                @endphp
                <p class="text-2xl font-bold text-blue-600 mb-2">
                    {{ number_format($availablePoints) }} {{ __('Points') }}
                </p>
                <a href="{{ route('account.points') }}" class="text-blue-600 hover:text-blue-800">
                    {{ __('View Details') }}
                </a>
