 ...
 * @coversNothing
 */
final class AuthenticateWithBasicAuthTest extends TestCase
{
    use RefreshDatabase;

    public function testAuthenticateWithBasicAuthMiddlewareHandlesRequests(): void
    {
        ...
        $middleware = $this->app->make(AuthenticateWithBasicAuth::class);
    ...
    public function testAuthenticateWithBasicAuthMiddlewareHandlesInvalidCredentials(): void
    {
        $request = Request::create('/test', 'GET');
        $request->headers->set('PHP_AUTH_USER', 'test@example.com');
    ...
    public function testAuthenticateWithBasicAuthMiddlewareHandlesMissingAuthorization(): void
    {
        $request = Request::create('/test', 'GET');
    ...
    public function testAuthenticateWithBasicAuthMiddlewareHandlesMalformedAuthorization(): void
    {
        $request = Request::create('/test', 'GET');
    ...
    public function testAuthenticateWithBasicAuthMiddlewareHandlesPostRequests(): void
    {
